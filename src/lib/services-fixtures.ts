...
const INITIAL_SERVICE_FIXTURES: Service[] = [
  ...
  },
  {
    ...
    serviceTypeId: "st-container-survey",
    serviceTypeName: "Relevamiento de contenedores",
    title: "Relevamiento de contenedor — Sector 20",
    mode: "POINT",
    status: "SCHEDULED",
    statusReason: null,
    origin: "MANUAL",
  ...
  },
  {
    ...
    serviceTypeId: "st-dump-clearing",
    serviceTypeName: "Limpieza especial",
    title: "Denuncia — microbasural en Ribera Norte",
    mode: "POINT",
    status: "RESCHEDULED",
    statusReason: "Corte de calle no habilitado por Tránsito",
    origin: "TICKET",
    ticketId: "TK-2026-00512",
    zoneIds: ["zone-1"],
    zoneNames: ["Zona Norte"],
    scheduledDate: "2026-09-06",
    windowFrom: "10:00",
    ...
    history: [
      { label: "Programado", at: "2026-09-05 07:00", done: true },
      { label: "A reprogramar", at: "2026-09-05 11:00", done: true },
    ],
    notes: "Reservado para pruebas de cancelación desde RESCHEDULED.",
  },
  {
    id: "SVC-1092",
    serviceTypeId: "st-container-repair",
    serviceTypeName: "Mantenimiento de contenedores",
    title: "Retiro de contenedor dañado CT-0930",
    mode: "POINT",
    status: "SUSPENDED",
    statusReason: "Acceso bloqueado por obras en calzada",
    origin: "TICKET",
    ticketId: "TK-2026-00513",
    zoneIds: ["zone-1"],
    zoneNames: ["Zona Norte"],
    targetType: "CONTAINER",
    targetId: "cont-5",
    ...
    history: [
      ...
      { label: "En curso", at: "2026-09-05 11:00", done: true },
      { label: "Suspendido", at: "2026-09-05 11:30", done: true },
    ],
    notes: "Reservado para pruebas de cancelación desde SUSPENDED.",
  },
  {
    id: "SVC-1093",
    serviceTypeId: "st-waste-route",
    serviceTypeName: "Recolección de residuos",
    title: "Recolección de residuos — Recorrido 8",
    mode: "ROUTE",
    status: "IN_PROGRESS",
    statusReason: null,
    origin: "PLANNED",
    ...
    history: [
      ...
      { label: "En curso", at: "2026-09-05 09:05", done: true },
    ],
    notes: "Reservado para pruebas de rechazo de cancelación directa desde IN_PROGRESS.",
  },
  {
    id: "SVC-1094",
    serviceTypeId: "st-street-cleaning",
    serviceTypeName: "Barrido mecánico",
    title: "Barrido mecánico — Recorrido 9",
    mode: "ROUTE",
    status: "IN_PROGRESS",
    statusReason: null,
    origin: "PLANNED",
    ...
    notes: "Reservado para pruebas de borrador local y conflicto de suspensión (#97).",
  },
  {
    id: "SVC-1095",
    serviceTypeId: "st-street-cleaning",
    serviceTypeName: "Barrido mecánico",
    title: "Barrido mecánico — Recorrido 10",
    mode: "ROUTE",
    status: "SCHEDULED",
    statusReason: null,
    origin: "PLANNED",
    ...
    notes: "Reservado para pruebas de borrador local sin conflicto (#97).",
  },
  {
    id: "SVC-1096",
    serviceTypeId: "st-street-cleaning",
    serviceTypeName: "Barrido mecánico",
    title: "Barrido mecánico — Recorrido 11",
    mode: "ROUTE",
    status: "SCHEDULED",
    statusReason: null,
    origin: "PLANNED",
    ...
    notes: "Reservado para pruebas de inicio libre de cuadrilla B, sin dependencia de corte de calle (#117).",
  },
  {
    id: "SVC-1097",
    serviceTypeId: "st-street-cleaning",
    serviceTypeName: "Barrido mecánico",
    title: "Barrido mecánico — Recorrido 12",
    mode: "ROUTE",
    status: "SCHEDULED",
    statusReason: null,
    origin: "PLANNED",
