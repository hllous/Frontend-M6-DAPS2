...
/** Fecha y franja de la inspección: son del servicio vinculado, no de la inspección. */
function inspectionAgenda(service: Service): string {
  const window = service.windowFrom && service.windowTo ? ` · ${service.windowFrom}–${service.windowTo}` : "";
